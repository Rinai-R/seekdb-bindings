...
C library, CLI, Go binding, and Python binding for [seekdb](https://github.com/oceanbase/seekdb).
...
├── go/                         native Go API + database/sql integration
...
The Go package exposes both the native `libseekdb` API and a `database/sql`
connection compatible with GORM and other standard Go database tooling. See
[`go/README.md`](go/README.md) for setup and examples.
